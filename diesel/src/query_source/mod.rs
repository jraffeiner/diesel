...
// TODO: diesel 3.0 change the super trait here to `QueryRelationField`
...
/// should have been generated by the [`table!` macro](crate::table!) or
/// the [`view!` macro](crate::view!
...
///
/// Types which implement this trait are usually generated by the [`table!` macro](crate::table!)
pub trait QueryRelation: QuerySource + AsQuery + Sized {
...
pub trait Table: QuerySource + AsQuery + Sized {
    ...
    /// Returns a tuple of all columns belonging to this table.
    // TODO: diesel 3.0 drop this in favour of QueryRelation::all_columns
    fn all_columns() -> Self::AllColumns;
}
...
where
    T: Table,
{
    type AllColumns = <T as Table>::AllColumns;
...
pub trait TableNotEqual<T: QueryRelation>: QueryRelation {}
