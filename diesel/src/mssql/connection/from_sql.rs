use crate::mssql::connection::{tds::Numeric, xml::XmlData, ColumnData};
use uuid::Uuid;
...
pub(crate) trait FromSqlOwned<'a>
where
    Self: Sized,
{
    /// Returns the value, `None` being a null value, taking the ownership.
    fn from_sql_owned(value: ColumnData<'a>) -> crate::mssql::connection::Result<Option<Self>>;
}
...
impl<'a> FromSqlOwned<'a> for XmlData {
    fn from_sql_owned(value: ColumnData<'a>) -> crate::mssql::connection::Result<Option<Self>> {
        if value.is_null() {
            return Ok(None);
        }
...
impl<'a> FromSqlOwned<'a> for String {
    fn from_sql_owned(value: ColumnData<'a>) -> crate::mssql::connection::Result<Option<Self>> {
        if value.is_null() {
            return Ok(None);
        }
...
impl<'a> FromSqlOwned<'a> for Vec<u8> {
    fn from_sql_owned(value: ColumnData<'a>) -> crate::mssql::connection::Result<Option<Self>> {
        if value.is_null() {
            return Ok(None);
        }
