...
impl FromStr for AdoNetConfig {
    type Err = crate::mssql::connection::error::Error;

    fn from_str(s: &str) -> crate::mssql::connection::Result<Self> {
        let dict = s.parse()?;
        Ok(Self { dict })
    }
}
...
impl ConfigString for AdoNetConfig {
    ...
    fn server(&self) -> crate::mssql::connection::Result<ServerDefinition> {
        fn parse_port(parts: &[&str]) -> crate::mssql::connection::Result<Option<u16>> {
        ...
        fn parse_server(parts: Vec<&str>) -> crate::mssql::connection::Result<ServerDefinition> {
            if parts.is_empty() || parts.len() >= 3 {
                return Err(crate::mssql::connection::Error::Conversion(
                    "Server value faulty.".into(),
                ));
            }
...
mod tests {
    use super::*;
    use crate::mssql::connection::client::AuthMethod;
    ...
    use crate::mssql::connection::EncryptionLevel;

    #[test]
    fn server_parsing_no_browser() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn server_parsing_no_tcp() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn server_parsing_local() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn server_parsing_local_no_tcp() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn server_parsing_no_port() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn server_parsing_with_browser() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn server_parsing_with_browser_and_port() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn database_parsing() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_true() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_false() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_yes() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_no() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_missing() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_faulty() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn trust_cert_ca_parsing_ok() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn parsing_sql_server_authentication() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    #[cfg(windows)]
    fn parsing_sspi_authentication() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    #[cfg(windows)]
    fn parsing_windows_authentication() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn parsing_database() -> crate::mssql::connection::Result<()> {
    ...
    #[test]
    fn parsing_login_credentials_escaping() -> crate::mssql::connection::Result<()> {
    ...
    fn encryption_parsing_on() -> crate::mssql::connection::Result<()> {
    ...
    fn encryption_parsing_off() -> crate::mssql::connection::Result<()> {
    ...
    fn encryption_parsing_plaintext() -> crate::mssql::connection::Result<()> {
    ...
    fn encryption_parsing_missing() -> crate::mssql::connection::Result<()> {
        let test_str = "";
        let ado: AdoNetConfig = test_str.parse()?;
    ...
    #[test]
    fn application_name_parsing() -> crate::mssql::connection::Result<()> {
