...
impl Config {
    ...
    pub(crate) fn encryption(&mut self, encryption: EncryptionLevel) {
    ...
    ///
    /// [ADO.NET connection string]: https://docs.microsoft.com/en-us/dotnet/framework/data/adonet/connection-strings
    pub fn from_ado_string(s: &str) -> crate::mssql::connection::Result<Self> {
    ...
    pub fn from_jdbc_string(s: &str) -> crate::mssql::connection::Result<Self> {
        let jdbc: JdbcConfig = s.parse()?;
        Self::from_config_string(jdbc)
    }

    fn from_config_string(s: impl ConfigString) -> crate::mssql::connection::Result<Self> {
...
pub(crate) trait ConfigString {
    ...
    fn authentication(&self) -> crate::mssql::connection::Result<AuthMethod> {
        let user = self
            .dict()
            .get("uid")
    ...
    fn trust_cert(&self) -> crate::mssql::connection::Result<bool> {
        self.dict()
    ...
    #[cfg(any(feature = "rustls", feature = "native-tls",))]
    fn encrypt(&self) -> crate::mssql::connection::Result<EncryptionLevel> {
        self.dict()
            .get("encrypt")
    ...
    fn parse_bool<T: AsRef<str>>(v: T) -> crate::mssql::connection::Result<bool> {
