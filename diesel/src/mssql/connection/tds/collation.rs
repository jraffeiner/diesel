...
impl Collation {
    ...
    pub(crate) fn encoding(&self) -> crate::mssql::connection::Result<&'static Encoding> {
...
pub(crate) fn lcid_to_encoding(locale: u16) -> Option<&'static Encoding> {
    match locale {
...
pub(crate) fn sortid_to_encoding(sort_id: u8) -> Option<&'static Encoding> {
    match sort_id {
...
mod tests {
    ...
    use crate::mssql::connection::tests::new_connection;
