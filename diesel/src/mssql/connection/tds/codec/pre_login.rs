...
use crate::mssql::connection::{tds, Error, Result};
...
#[derive(Debug, Clone)]
#[cfg_attr(test, derive(PartialEq))]
pub(crate) struct PreloginMessage {
    /// [BE] token=0x00
...
impl PreloginMessage {
    ...
    pub(crate) fn negotiated_encryption(&self, expected: EncryptionLevel) -> EncryptionLevel {
