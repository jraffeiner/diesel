...
use crate::mssql::connection::{tds::Collation, xml::XmlSchema, Error, SqlReadBytes};
...
impl VarLenContext {
    pub(crate) fn new(r#type: VarLenType, len: usize, collation: Option<Collation>) -> Self {
        Self {
            r#type,
            len,
            collation,
    ...
    pub(crate) fn r#type(&self) -> VarLenType {
        self.r#type
    }
        ...
        match VarLenType::try_from(ty) {
            ...
            Ok(ty) => {
                let len = match ty {
                    ...
                    | VarLenType::Guid
                    | VarLenType::Money
                    | VarLenType::Datetimen => src.read_u8()? as usize,
                    VarLenType::NChar
                    | VarLenType::BigChar
                    | VarLenType::NVarchar
                    | VarLenType::BigVarChar
...
mod tests {
    ...
    fn round_trip() {
        ...
        for ti in types {
            ...
            let nti =
                TypeInfo::decode(&mut buf.into_sql_read_bytes()).expect("decode must succeed");
