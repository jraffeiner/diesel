use crate::mssql::connection::MetaDataColumn;
...
impl<'a> BytesMutWithDataColumns<'a> {
    pub(crate) fn new(bytes: &'a mut BytesMut, data_columns: &'a Vec<MetaDataColumn<'a>>) -> Self {
    ...
    pub(crate) fn data_columns(&self) -> &'a Vec<MetaDataColumn<'a>> {
        self.data_columns
    }
}
