...
use crate::mssql::connection::{tds::codec::ColumnData, BytesMutWithTypeInfo, Result};
...
#[derive(Debug)]
pub(crate) struct TokenRpcRequest<'a> {
...
impl<'a> TokenRpcRequest<'a> {
    pub(crate) fn new<I>(proc_id: I, params: Vec<RpcParam<'a>>, transaction_desc: [u8; 8]) -> Self
    where
